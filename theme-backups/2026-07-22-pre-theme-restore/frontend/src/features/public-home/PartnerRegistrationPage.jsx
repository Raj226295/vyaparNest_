...
const wizardIllustrationGif = '/partner-registration-secure-payment-transparent.gif'
...
function StepIllustration({ paymentSuccessful }) {
  return (
    <div className="partner-wizard-illustration" aria-hidden="true">
      ...
      <div className="partner-wizard-illustration-card">
        {paymentSuccessful ? (
          <Icon name="check" className="partner-wizard-illustration-icon" />
        ) : (
          <img
            src={wizardIllustrationGif}
            alt=""
            className="partner-wizard-illustration-image"
          />
        )}
      </div>
    </div>
